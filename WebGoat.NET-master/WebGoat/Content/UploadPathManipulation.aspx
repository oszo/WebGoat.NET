...
<p />
    ...
    <asp:Label ID="labelPMUpload" runat="server" Visible="false">
...
<div class="tiny" style="text-align:center">Attach a file (PDF, Excel or Plain Text)...
    ...
    <p>&nbsp;</p>
    <asp:Button ID="PMbtnUpload" runat="server" Text="Upload File!" CssClass="button medium blue" onclick="PMbtnUpload_Click" />
</div>
</asp:Content>
